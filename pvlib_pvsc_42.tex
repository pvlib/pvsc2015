...
PVLIB-Python currently provides most of the functionality of its parent PVLIB-Matlab package. 
The package is hosted on GitHub.com and co-developed by GitHub contributors. 
We also describe several PVLIB-Python use cases (really?).
\end{abstract}
...
\bibitem{andrews}Robert W. Andrews, Joshua S. Stein, Clifford Hansen, and Daniel Riley, ``Introduction to the Open Source PV LIB for Python Photovoltaic System Modelling Package", \emph {in 40th IEEE Photovoltaic Specialist Conference}, 2014. 
